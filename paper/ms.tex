...
Since an azimuthal-dependent midplane is effectively a departure from a perfectly axisymmetric potential, we In a slowly-evolving axisymmetric potential, the actions of stars' orbits are
...
For an error in the $x$ component (or Solar radius), the 95\textsuperscript{th} minus
5\textsuperscript{th} percentiles are $x$, $y$, and $z \actunit$ for $J_r$, $L_z$ and
$J_z$, respectively. These are fractional errors of $x\%$, $y\%$ and $z\%$,
respectively.
...
\caption{\Gus{update figure} We report the 95\uth minus 5\uth percentile of the error in the
measured action ($\Delta J_i$) from coordinate system errors for three orbits
with low-, medium-, and high-$J_z$ values (blue, orange, and red,
respectively). The {\em left}, {\em center}, and {\em right} panels show the
