...
\section{Coordinate System Offsets II. Measurement Errors} \label{sec:mes_err}
We consider the second potential source of coordinate system offsets which
...
In the epicyclic approximation (Section~\ref{ssec:epi_action}), the $0.3\%$
error in $R_0$ induces a $5.4\%$ and $5.9\%$ error in the thin-disk and
thick-disk orbits, respectively. For $J_{\phi}$, the error is $0.3\%$ for both
orbits.
...
Third, one must define the Sun's vertical distance from the Galactic midplane, $z_{\odot}$.
It can be determined by identifying where the stellar density and
...
Under the epicyclic approximation, the highest precision measurement of
$z_{\odot}$ of $1.4\%$ from \citet{2019MNRAS.482.1417B} induces a $0.5\%$ and
$0.04\%$ error in $J_z$ for the thick-disk and thin-disk orbits, respectively.
The discrepancy between the stellar and gas midplanes of $\sim5\,\pc$ induces
an $8.3\%$ and $1.2\%$ error in $J_z$ for the two orbits.
...
Since chemical tagging \citep{2002ARA&A..40..487F} is not subject to the same systematic errors discussed in this paper, it should be used to confirm dynamical associations and to offset the effect of these systematic errors on the action-space distribution function. %The importance of combining chemistry and dynamics for Galactic archaeology was recently pointed out by \citet{2019arXiv190210719K}.
