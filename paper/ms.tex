...
oscillations has been known for some time, observed in 1957 for H~%mm
   % \textsc{i}
   {\sc i}
...
orbit can be identified, then it might be possible to constrain the disk
potential in analogy to how stellar streams are used to constrain the Galactic
potential \citep[e.g.][]{1999ApJ...512L.109J, 2001ApJ...551..294I,
...
challenge. One would want to use the same constants of motion that we discuss
are suscept to significant errors. On the other hand, one could use chemical
tagging to identify a disrupted open cluster \citep{2002ARA&A..40..487F}, but
it may be difficult due to the large number of stars that are chemically
indistinguishable but are presumably born in different clusters
