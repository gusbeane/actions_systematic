...
parameters of that model. We are only concerned with an inaccuracy in the
Galactocentric coordinate system and, in particular, the measurement of the
Galactic midplane. Here we determine how an error in either the Galactic
midplane or Galactocentric radius propagates into an error in the various
actions.
