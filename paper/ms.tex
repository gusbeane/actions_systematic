...
%mm  the true action value. [the error in a Gaussian peaks on zero] 
    the null value.
A variation in the vertical position midplane of $\sim30\,\pc$ for a thin disk orbit or
$\sim225\,\pc$ for a thick disk orbit is 
%mm all that is necessary 
      sufficient
to induce a $100\,\%$ systematic error in the vertical action $J_z$ computed under the assumption of an axisymmetric potential.
