...
of a star's orbit. A systematic bias in the phase space position induces a
phase-dependence in the actions, which we interpret as a systematic error
distinct from typical observational errors and Galactic potential uncertainties.
An offset in the vertical position of $\sim15\,\pc$ ($\sim120\,\pc$) for a thin
(thick) disk orbit is sufficient to induce a $25\%$ systematic error in the
