...
(orange, teal, and green respectively). As before, the error ($\Delta J_z$) is one
...
the location of the ``dynamical Galactic center,'' i.e., the point in
...
On shorter scales, they are likely the dominant source of error, and they are
likely to be important for detailled modelling of kinematically cold stars.
