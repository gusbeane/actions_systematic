...
\keywords{Milky Way disk -- Milky Way evolution -- Milky Way dynamics --
...
we consider offsets in the $x$ component (i.e. the solar radius). The left,
center, and right columns show the fractional spread in the values computed
for $J_z$, $J_{\phi}$, and $J_R$, respectively.
...
the same deviation for \thick{}. We find that \halo{} is relatively resistant
to errors in the midplane, with only $\sim15\%$ error in $J_z$ out to an
offset of $500\,\pc$.
