...
These simulations contain dark matter particles of mass $\sim$35,000 \Msun,
...
gas disk is thought to have a scale height of {\bf XXX} pc (XX times the
median gas softening length) and the thin stellar disk a scale height of {\bf
XXX} pc (XX times the stellar softening length). We therefore expect that
...
the simulated galaxies are all somewhat larger than the MW's. However, in this
...
Large Magellanic Cloud. One of the three we consider (\m12f) does have an
...
Using the three simulations, we determine the \emph{local} midplane that an
observer might measure if they were situated in each of these galaxies. We
place our imaginary observer at the solar radius of $8.2\,\kpc$ and azimuth
$0<\phi<2\pi$\footnote{Our nearly immortal observer also has warp-drive.}, and
consider stars within a cylinder of radius $0.5\,\kpc$ and height $1\,\kpc$
perpendicular to the fiducial disk.
