...
both phase dependent. We consider two cases. First, at the point of maximum
...
Since most of the time stars will be at maximum amplitude in both the $R$ and
$z$ components, we can assume for most stars that
...
In the remainder of this section, we compare our analytic estimates of the effect on actions of a midplane offset against numerical calculations. Detailed worked on the effect of velocity offsets on actions is deferred to future work, as we discuss in Section~\ref{ssec:lsr_var}.
