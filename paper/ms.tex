...
stellar populations and possibly contributing to confusion there. This
...
$\bm{J}_i - \bm{J}_c \in V_e$, where $V_e$ is centered on $J_c$ and has size
proportional to the intrinsic action-space dispersion of the disrupting
...
in the thin disk, this background is not likely to be negligible, but we will
assume for the sake of argument that it can be modeled within the ``dynamical
...
Figure~\ref{fig:many_orbit_wrong_ref} to determine the midplane $z$ offset
...
for the allowable midplane offset for these two orbits in shown in Figure
\ref{fig:cluster_offset} as a function of cluster mass.
...
should be possible in the near future with Gaia, with quality distance
