...
\newcommand{\z}{z}
\newcommand{\uth}{\textsuperscript{th}} % why is this so long in the first place??
...
we also subtract the best fit $\text{A} \sin{\phi + \text{B}} + C$ curve from
the midplane as a function of azimuth. For $\text{A}$, the values are $-165$,
