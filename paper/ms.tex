...
both phase dependent via Eq. \eqref{eq:orbits_epi}. We consider two cases. First, at the point of maximum
...
approximation from Equation~\ref{eq:Ji_err_mosttime}. This Equation is relevant since during most of the orbit the star will be at maximum radial and vertical amplitude and we do not consider velocity offsets. Note that we consider an error
...
/ J_z$ from Equation~\ref{eq:Ji_err_mosttime} as dashed lines for each $z$
