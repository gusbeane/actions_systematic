...
between $0<\phi<2\pi$.\footnote{The immortal observer also has warp drive, allowing them to travel around the galaxy much more quickly than its dynamical timescale (warp factor $\sim0.25$). Using warp drive allows them to sidestep time dilation effects.} At
